...
(function ($, undefined) {
  ...
  Datepicker.prototype = {
    ...
    place: function () {
      ...
      if (yorient === 'auto') {
        ...
        bottom_overflow = scrollTop + windowHeight - (top + height
            + calendarHeight);
    ...
    fillDow: function () {
      ...
      while (dowCnt < this.o.weekStart + 7) {
        html += '<th class="dow">' + dates[this.o.language].daysMin[(dowCnt++)
        % 7] + '</th>';
      }
      html += '</tr>';
    ...
    fill: function () {
      var d = new Date(this.viewDate),
          ...
          endYear = this.o.endDate !== Infinity
              ? this.o.endDate.getUTCFullYear() : Infinity,
      ...
      while (prevMonth.valueOf() < nextMonth) {
        if (prevMonth.getUTCDay() === this.o.weekStart) {
          ...
          if (this.o.calendarWeeks) {
            ...
            var
                ...
                ws = new Date(
                    +prevMonth + (this.o.weekStart - prevMonth.getUTCDay() - 7)
                    % 7 * 864e5),
                ...
                yth = new Date(
                    Number(yth = UTCDate(th.getUTCFullYear(), 0, 1)) + (7 + 4
        ...
        html.push(
            '<td class="' + clsName.join(' ') + '"' + (tooltip ? ' title="'
            + tooltip + '"' : '') + '>' + prevMonth.getUTCDate() + '</td>');
        tooltip = null;
  ...
  var DPGlobal = {
    ...
    parseDate: function (date, format, language) {
      ...
      date = UTCDate(date.getFullYear(), date.getMonth(), date.getDate(), 0, 0,
          0);
